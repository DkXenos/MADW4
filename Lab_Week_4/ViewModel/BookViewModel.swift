...
class BookViewModel: ObservableObject {
    @Published var books: [Book] = [
        Book(
            ...
            author: "Apple",
            icon: "swift",
            description: "The official guide to Swift. A must-read for iOS developers. This book covers everything from basic syntax to advanced features like generics, protocols, and concurrency.",
            pages: 1000
        ),
        Book(
            title: "1984",
